...
def test_user_getRegularPath():
    querys = [
        f"INSERT INTO `userNogaspi` (`id`, `mail`, `password`, `pseudo`, `profilePicture`, `token`, `token_expiration`, `points`, `regularPathLatitudeStart`, `regularPathLongitudeStart`, `regularPathLatitudeEnd`, `regularPathLongitudeEnd`, `regularPathPoints`, `lastPathType`) VALUES (1, 'toto@toto.fr', 'toto', 'toto', NULL, 'token_toto', NOW() + INTERVAL 1 DAY, '0', 43.5844, 1.4626, 43.6108, 1.41365, '\\\"{regularPathPoints}\\\"', 'car');"
    ]
...
def test_user_getRegularPath_with_not_regularPath():
    querys = [
        "INSERT INTO `userNogaspi` (`id`, `mail`, `password`, `pseudo`, `profilePicture`, `token`, `token_expiration`, `points`, `regularPathLatitudeStart`, `regularPathLongitudeStart`, `regularPathLatitudeEnd`, `regularPathLongitudeEnd`, `regularPathPoints`, `lastPathType`) VALUES (1, 'toto@toto.fr', 'toto', 'toto', NULL, 'token_toto', NOW() + INTERVAL 1 DAY, '0', 43.5844, 1.4626, 43.6108, 1.41365, NULL, 'car');"
    ]
    sqlQuerysWithCommit(querys)
...
def test_user_getRegularPath_with_not_path_type():
    querys = [
        f"INSERT INTO `userNogaspi` (`id`, `mail`, `password`, `pseudo`, `profilePicture`, `token`, `token_expiration`, `points`, `regularPathLatitudeStart`, `regularPathLongitudeStart`, `regularPathLatitudeEnd`, `regularPathLongitudeEnd`, `regularPathPoints`, `lastPathType`) VALUES (1, 'toto@toto.fr', 'toto', 'toto', NULL, 'token_toto', NOW() + INTERVAL 1 DAY, '0', 43.5844, 1.4626, 43.6108, 1.41365, '\\\"{regularPathPoints}\\\"', NULL);"
    ]
    sqlQuerysWithCommit(querys)
